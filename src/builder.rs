...
//! builder — orchestration layer between Muffin (config) and the execution layer (std-only)
//!
//! Role in the pipeline
//! - `build muffin` resolves workspace configuration and emits a `.mff` (Muffinconfig)
